defmodule Benchee.Conversion.MemoryTest do
  ...
  describe ".convert" do
    ...
    test "convert mb to kb returns correct result for atom" do
      ...
      expected_value = 8 * 1024
      assert actual_value == {expected_value, :kilobyte}
    end
  end
end