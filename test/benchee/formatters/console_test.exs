defmodule Benchee.Formatters.ConsoleTest do
  ...
  test "sorts the the given stats fastest to slowest" do
    second = {"Second", %{average: 200.0, ips: 5_000.0,  std_dev_ratio: 0.1}}
    third  = {"Third",  %{average: 400.0, ips: 2_500.0,  std_dev_ratio: 0.1}}
    first  = {"First",  %{average: 100.0, ips: 10_000.0, std_dev_ratio: 0.1}}
